...
class RegisterUserSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        send_mail(
            ...
            f'Hello, Please use the following validation code: {registration.code} to continue your'
            ' registration at http://luna-sagittarius.propulsion-learn.ch .',
            'luna.sagittarius.propulsion@gmail.com',
            [new_user.email],
            fail_silently=False,
        )
